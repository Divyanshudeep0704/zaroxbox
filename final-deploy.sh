...
# Final deployment script - uploads files and runs setup
...
echo "scp vps-install.sh root@178.128.28.19:/tmp/"
echo ""
echo "# Step 2: Run installation"
echo "ssh root@178.128.28.19 'bash /tmp/vps-install.sh'"
echo ""
echo "Password when prompted: always@1Number"
echo ""
echo "=================================================="
echo ""
